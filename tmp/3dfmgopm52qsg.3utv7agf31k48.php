...
<div class="row border-bottom">
    <nav class="navbar navbar-static-top <?php echo isset($_topLineColor) ? $_topLineColor : ''; ?>" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            <a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
            <h3 class="company-nav-title dropdown">
                <a href="#" data-toggle="dropdown"><?php echo $CompanyData['Title']; ?> <span class="caret"></span></a>
