                    ...
                    <div class="col-md-8">
                        ...
                        <div class="tabs-container">
                            <ul class="nav nav-tabs">
                                ...
                                <check if="{{ @ProjectRight_ManageEmployees }}">
                                    <li class=""><a data-toggle="tab" href="#employeeTab"> Исполнители</a></li>
                                </check>
                                <check if="{{ @ProjectRight_Edit }}">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <ul id="OpenTaskList" class="todo-list m-t m-b">
                                            <repeat group="{{ @TaskListOpen }}" value="{{ @task }}">
                                                <li class="custom" data-id="{{ @task.TaskId }}">
                                                    <a href="#taskDescription" data-id="{{ @task.TaskId }}" class="task-item" data-toggle="modal">
                                                        ...
                                                        <check if="{{ @ProjectRight_CompleteTask }}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <check if="{{ @ProjectRight_EditTask }}">
                ...
                <div class="modal-footer">
                    <check if="{{ @ProjectRight_DeleteTask }}">
